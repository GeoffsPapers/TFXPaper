...
The grammar for THX is captured in version v7.1.0.2 of the TPTP syntax,
available online at \url{http://www.tptp.org/TPTP/SyntaxBNF.html}.
This provides the automatically generated lex/yacc parsers for TPTP files.
...
and let expressions.
TFX is usefule for (at least) concisely expressing problems coming from 
